...
namespace SpaceGraphicsToolkit {
    ...
    public class SgtTerrainShadowLayer : MonoBehaviour {
        ...
        public SgtShadowLayer ShadowLayer { set { shadowLayer = value; } get { return shadowLayer; } }
        [SerializeField] private SgtShadowLayer shadowLayer;
        ...
        private void HandleDrawQuad(Camera camera, SgtTerrainQuad quad, Matrix4x4 matrix, int layer) {
            if (shadowLayer != null) {
                var finalMaterial = shadowLayer.getMaterial();
